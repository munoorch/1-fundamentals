...
if [ ! -d $PROJECT_DIR"/.git" ]; then
  GIT_SSH_COMMAND='ssh -i ~/.ssh/id_rsa -o IdentitiesOnly=yes' sudo git clone git@github.com:munoorch/1-fundamentals.git .
...
useradd -G www-data,root -u 1000 -d /home/mhd mhd
mkdir -p /home/mhd/.ssh
touch /home/mhd/.ssh/authorized_keys
chown -R mhd:mhd /home/mhd
chown -R mhd:mhd /var/www/html
chmod 700 /home/mhd/.ssh
chmod 644 /home/mhd/.ssh/authorized_keys

echo "$SSH_KEY" >> /home/mhd/.ssh/authorized_keys

echo "mhd ALL=(ALL) NOPASSWD: ALL" >> /etc/sudoers.d/mhd
