...
if [ ! -d $PROJECT_DIR"/.git" ]; then
  GIT_SSH_COMMAND='ssh -i /home/mhd/.ssh/id_rsa -o IdentitiesOnly=yes' git clone https://github.com/munoorch/1-fundamentals .
else
  GIT_SSH_COMMAND='ssh -i /home/mhd/.ssh/id_rsa -o IdentitiesOnly=yes' git pull
fi
